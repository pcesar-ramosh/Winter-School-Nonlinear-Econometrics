'Modelos de Umbrales - Cesar Ramos
close @all
...
' Rótulos discretos para las variables transformadas (sin revelar contenido específico)
g_x20.displayname ?% Portafolio - Total
g_x21.displayname ?% Incumplimiento
g_x23.displayname ?% Provisión cartera
g_x25.displayname ?% Índice de precios
g_x26.displayname ?% Índice de actividad
g_x30.displayname ?% Exigencia B

x31.displayname Tasa P (M1)
x32.displayname Tasa A (M1)

g_x41.displayname ?% Índice TC (real)
g_x47.displayname ?% Depósitos (MN)
g_x48.displayname ?% Indicador ext. 1
g_x49.displayname ?% Indicador ext. 2
g_x51.displayname ?% Oper. M.
x52.displayname Tasa instrumento S-91
x53.displayname Índice de moneda (dep.)
g_x54.displayname ?% Liquidez
...
equation stl_06estr.threshold(type=smooth, optmethod=newton, maxit=100000, cov=white) g_x20 g_x23 x31 x32(-3) @nv g_x30 g_x21(-6) g_x25 g_x47 @thresh g_x26(-3)
...
equation ste_01estr.threshold(type=smooth, optmethod=newton, optstep=linesearch, maxit=100000, cov=white, smoothtrans=exponential) g_x20 g_x23 c x32 @nv g_x30 g_x25 x31 @thresh g_x26(-5)
